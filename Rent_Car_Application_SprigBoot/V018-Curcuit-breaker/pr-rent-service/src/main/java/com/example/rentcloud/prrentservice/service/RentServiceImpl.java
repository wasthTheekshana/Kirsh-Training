...
import com.example.rentcloud.prrentservice.hystrix.CommonHystrixCommand;
import com.example.rentcloud.prrentservice.hystrix.VehicleCommand;
...
public class RentServiceImpl implements RentService{
    ...
    @Override
    public DetailResponse findDEDetailResponse(int id) throws ExecutionException, InterruptedException {
    ...
    private Customer getCustomer(int id) throws ExecutionException, InterruptedException {
