...
public class RentServiceImpl implements RentService{
    ...
    private Customer getCustomer(int id){
       return restTemplate.getForObject("http://localhost:8080/services/customers/"+id,Customer.class);
    }

    private Vehicle getVehicle(int vehicleId){
        return restTemplate.getForObject("http://localhost:9191/service/vehicles/"+vehicleId,Vehicle.class);
    }
}
